...
namespace Автошкола
{
    public class BusinessLogic
    {
        ...
        public AutoschoolDataSet ReadByCarrierReplacementID_AND_BeginEndDates(int CarrierReplacementID, DateTime BeginDate, DateTime EndDate)
        {
            AutoschoolDataSet ds = new AutoschoolDataSet();
            AbstractConnection abstrCon = ConnectionFactory.getConnection();
            abstrCon.Open();
            ...
            try
            {
                ...
                instructorsDA.Read(ds, abstrCon, abstrTr);
                carriersUsesDA.Read(ds, abstrCon, abstrTr);
                replacementsCarriersDA.ReadByCarrierReplacementID_AND_BeginEndDates(ds, abstrCon, abstrTr, CarrierReplacementID, BeginDate, EndDate);
                abstrTr.Commit();
            }
            catch (Exception e)
            {
        ...
        public AutoschoolDataSet ReadCarriersRepairsByBeginEndDates(DateTime BeginDate, DateTime EndDate)
        {
            AutoschoolDataSet ds = new AutoschoolDataSet();
            AbstractConnection abstrCon = ConnectionFactory.getConnection();
            abstrCon.Open();
            ...
            try
            {
                ...
                transmissionsDA.Read(ds, abstrCon, abstrTr);
                carriersDA.Read(ds, abstrCon, abstrTr);
                carriersRepairsDA.ReadByBeginEndDates(ds, abstrCon, abstrTr, BeginDate, EndDate);
                abstrTr.Commit();
            }
            catch (Exception e)
            {
        ...
        public AutoschoolDataSet ReadByCarrierID_AND_CrossInBeginEndDates(int CarrierID, DateTime BeginDate, DateTime EndDate)
        {
            AutoschoolDataSet ds = new AutoschoolDataSet();
            AbstractConnection abstrCon = ConnectionFactory.getConnection();
            abstrCon.Open();
            ...
            try
            {
                ...
                transmissionsDA.Read(ds, abstrCon, abstrTr);
                carriersDA.Read(ds, abstrCon, abstrTr);
                carriersRepairsDA.ReadByCarrierID_AND_CrossInBeginEndDates(ds, abstrCon, abstrTr, CarrierID, BeginDate, EndDate);
                abstrTr.Commit();
            }
            catch (Exception e)
            {
        ...
        public AutoschoolDataSet ReadPracticeLessonsNeedsForReplacement(DateTime BeginDate, DateTime EndDate)
        {
            AutoschoolDataSet ds = new AutoschoolDataSet();
            AbstractConnection abstrCon = ConnectionFactory.getConnection();
            abstrCon.Open();
            ...
            try
            {
                ...
                carriersUsesDA.Read(ds, abstrCon, abstrTr);
                studentsDA.Read(ds, abstrCon, abstrTr);
                practiceLessonsDA.ReadNeedsForReplacement(ds, abstrCon, abstrTr, BeginDate, EndDate);
                abstrTr.Commit();
            }
            catch (Exception e)
            {
        ...
        public AutoschoolDataSet ReadRepairingCarriers(DateTime Date)
        {
            AutoschoolDataSet ds = new AutoschoolDataSet();
            AbstractConnection abstrCon = ConnectionFactory.getConnection();
            abstrCon.Open();
            ...
            try
            {
                ...
                carriersStatusesDA.Read(ds, abstrCon, abstrTr);
                categoriesDA.Read(ds, abstrCon, abstrTr);
                multipleDA.ReadRepairingCarriers(ds, abstrCon, abstrTr, Date);
                abstrTr.Commit();
            }
            catch (Exception e)
            {
        ...
        public AutoschoolDataSet ReadReplacementsCarriersByBeginDateANDCarrierUseID(DateTime BeginDate, int CarrierUseID)
        {
            AutoschoolDataSet ds = new AutoschoolDataSet();
            AbstractConnection abstrCon = ConnectionFactory.getConnection();
            abstrCon.Open();
            ...
            try
            {
                ...
                instructorsDA.Read(ds, abstrCon, abstrTr);
                carriersUsesDA.Read(ds, abstrCon, abstrTr);
                replacementsCarriersDA.ReadReplacementsCarriersByBeginDateANDCarrierUseID(ds, abstrCon, abstrTr, BeginDate, CarrierUseID);
                abstrTr.Commit();
            }
            catch (Exception e)
            {
        ...
        public DataSet ReadCarriersUsesWithRepairingCarriers(DateTime BeginDate, DateTime EndDate)
        {
            DataSet ds = new DataSet();
            ds.Tables.Add("CarrierUsesWithRepairingCarriers");
            ds.Tables["CarrierUsesWithRepairingCarriers"].Columns.Add("CarrierID");
            ds.Tables["CarrierUsesWithRepairingCarriers"].Columns.Add("Brand");
            ds.Tables["CarrierUsesWithRepairingCarriers"].Columns.Add("Model");
            ds.Tables["CarrierUsesWithRepairingCarriers"].Columns.Add("StateNumber");
            ds.Tables["CarrierUsesWithRepairingCarriers"].Columns.Add("BeginDate");
            ds.Tables["CarrierUsesWithRepairingCarriers"].Columns.Add("EndDate");
            ds.Tables["CarrierUsesWithRepairingCarriers"].Columns.Add("InstructorID");
            ds.Tables["CarrierUsesWithRepairingCarriers"].Columns.Add("InstructorName");
            ds.Tables["CarrierUsesWithRepairingCarriers"].Columns.Add("CarrierUseID");
            ...
            try
            {
                ...
                multipleDA.ReadCarriersUsesWithRepairingCarriers(ds, abstrCon, abstrTr, BeginDate, EndDate);
        ...
        public AutoschoolDataSet ReadCategoriesOfInstructor(int InstructorID)
        {
            AutoschoolDataSet ds = new AutoschoolDataSet();
            AbstractConnection abstrCon = ConnectionFactory.getConnection();
            abstrCon.Open();
            ...
            try
            {
                abstrTr = abstrCon.BeginTransaction();
                ds.EnforceConstraints = false;
                multipleDA.ReadCategoriesOfInstructor(ds, abstrCon, abstrTr, InstructorID);
                abstrTr.Commit();
            }
            catch (Exception e)
            {
        ...
        public AutoschoolDataSet ReadCarriersByCategoryIDANDInstructorID(int CategoryID, int InstructorID)
        {
            AutoschoolDataSet ds = new AutoschoolDataSet();
            AbstractConnection abstrCon = ConnectionFactory.getConnection();
            abstrCon.Open();
            ...
            try
            {
                ...
                carriersStatusesDA.Read(ds, abstrCon, abstrTr);
                categoriesDA.Read(ds, abstrCon, abstrTr);
                multipleDA.ReadCarriersByCategoryIDANDInstructorID(ds, abstrCon, abstrTr, CategoryID, InstructorID);
                abstrTr.Commit();
            }
            catch (Exception e)
            {
        ...
        public AutoschoolDataSet ReadPracticeLessonsByCarrierID_AND_BeginEndDates(int CarrierID, DateTime BeginDate, DateTime EndDate)
        {
            AutoschoolDataSet ds = new AutoschoolDataSet();
            AbstractConnection abstrCon = ConnectionFactory.getConnection();
            abstrCon.Open();
            ...
            try
            {
                ...
                multipleDA.ReadPracticeLessonsByCarrierID_AND_BeginEndDates(ds, abstrCon, abstrTr, CarrierID, BeginDate, EndDate);
        ...
        public AutoschoolDataSet ReadPracticeLessonsByCarrierUseID_AND_DatesBeginEnd(int CarrierUseID, DateTime DateBegin, DateTime DateEnd)
        {
            AutoschoolDataSet ds = new AutoschoolDataSet();
            AbstractConnection abstrCon = ConnectionFactory.getConnection();
            abstrCon.Open();
            ...
            try
            {
                ...
                multipleDA.ReadPracticeLessonsByCarrierUseID_AND_DatesBeginEnd(ds, abstrCon, abstrTr, CarrierUseID, DateBegin, DateEnd);
        ...
        public AutoschoolDataSet ReadReplacementsCarriersByCarrierID_AND_Date(int CarrierID, DateTime Date)
        {
            AutoschoolDataSet ds = new AutoschoolDataSet();
            AbstractConnection abstrCon = ConnectionFactory.getConnection();
            abstrCon.Open();
            ...
            try
            {
                ...
                instructorsDA.Read(ds, abstrCon, abstrTr);
                carriersUsesDA.Read(ds, abstrCon, abstrTr);
                multipleDA.ReadReplacementsCarriersByCarrierID_AND_Date(ds, abstrCon, abstrTr, CarrierID, Date);
                abstrTr.Commit();
            }
            catch (Exception e)
            {
